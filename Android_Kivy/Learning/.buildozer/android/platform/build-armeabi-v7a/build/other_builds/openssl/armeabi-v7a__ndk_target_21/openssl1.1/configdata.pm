...
our %config = (
  AR => "llvm-ar",
  ARFLAGS => [ "rs" ],
  CC => "/home/ronit/.buildozer/android/platform/android-ndk-r19c/toolchains/llvm/prebuilt/linux-x86_64/bin/clang -target armv7a-linux-androideabi21 -fomit-frame-pointer -march=armv7-a -mfloat-abi=softfp -mfpu=vfp -mthumb -fPIC",
  ...
  CPPFLAGS => [ "-DANDROID -D__ANDROID_API__=21 -I/home/ronit/.buildozer/android/platform/android-ndk-r19c/sysroot/usr/include/arm-linux-androideabi -I/media/ronit/DATA21/Programming/Python_Random/Android_Kivy/Learning/.buildozer/android/platform/build-armeabi-v7a/build/python-installs/hellokivy/include/python3.8" ],
  CPPINCLUDES => [  ],
  CXX => "/home/ronit/.buildozer/android/platform/android-ndk-r19c/toolchains/llvm/prebuilt/linux-x86_64/bin/clang++ -target armv7a-linux-androideabi21 -fomit-frame-pointer -march=armv7-a -mfloat-abi=softfp -mfpu=vfp -mthumb -fPIC",
  CXXFLAGS => [ "-target armv7a-linux-androideabi21 -fomit-frame-pointer -march=armv7-a -mfloat-abi=softfp -mfpu=vfp -mthumb -fPIC" ],
  HASHBANGPERL => "/usr/bin/env perl",
  LDFLAGS => [ "  -L/media/ronit/DATA21/Programming/Python_Random/Android_Kivy/Learning/.buildozer/android/platform/build-armeabi-v7a/build/libs_collections/hellokivy/armeabi-v7a" ],
  LDLIBS => [ "-lm" ],
  PERL => "/usr/bin/perl",
  RANLIB => ":",
  RC => "windres",
  ...
  libdir => "",
  major => "1",
  makedepprog => "\$(CROSS_COMPILE)/home/ronit/.buildozer/android/platform/android-ndk-r19c/toolchains/llvm/prebuilt/linux-x86_64/bin/clang -target armv7a-linux-androideabi21 -fomit-frame-pointer -march=armv7-a -mfloat-abi=softfp -mfpu=vfp -mthumb -fPIC",
  minor => "1.1",
...
our %target = (
  ...
  cast_obj => "c_enc.o",
  cflags => "-pthread  -target armv7a-linux-androideabi -gcc-toolchain \$(ANDROID_NDK)/toolchains/arm-linux-androideabi-4.9/prebuilt/linux-x86_64 --sysroot=\$(ANDROID_NDK)/platforms/android-21/arch-arm",
  chacha_asm_src => "chacha_enc.c",
  chacha_obj => "chacha_enc.o",
  cmll_asm_src => "camellia.c cmll_misc.c cmll_cbc.c",
  cmll_obj => "camellia.o cmll_misc.o cmll_cbc.o",
  cppflags => "-D__ANDROID_API__=21 -isystem \$(ANDROID_NDK)/sysroot/usr/include/arm-linux-androideabi -isystem \$(ANDROID_NDK)/sysroot/usr/include",
  cpuid_asm_src => "mem_clr.c",
  cpuid_obj => "mem_clr.o",
  cxxflags => "-std=c++11 -pthread  -target armv7a-linux-androideabi -gcc-toolchain \$(ANDROID_NDK)/toolchains/arm-linux-androideabi-4.9/prebuilt/linux-x86_64 --sysroot=\$(ANDROID_NDK)/platforms/android-21/arch-arm",
  defines => [  ],
