...
our %config = (
  ...
  CPPFLAGS => [ "-DANDROID -D__ANDROID_API__=21 -I/home/ronit/.buildozer/android/platform/android-ndk-r19c/sysroot/usr/include/arm-linux-androideabi -I/media/ronit/DATA21/Programming/Python_Random/Android_Kivy/Learning/app/.buildozer/android/platform/build-armeabi-v7a/build/python-installs/yolo/include/python3.8" ],
  CPPINCLUDES => [  ],
  ...
  LDFLAGS => [ "  -L/media/ronit/DATA21/Programming/Python_Random/Android_Kivy/Learning/app/.buildozer/android/platform/build-armeabi-v7a/build/libs_collections/yolo/armeabi-v7a" ],
  LDLIBS => [ "-lm" ],
  PERL => "/usr/bin/perl",
  RANLIB => ":",
  RC => "windres",
